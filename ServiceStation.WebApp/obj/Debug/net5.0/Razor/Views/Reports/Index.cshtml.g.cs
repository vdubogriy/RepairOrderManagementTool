#pragma checksum "C:\Users\vasil\Desktop\ServiceStation.API\ServiceStation.API\ServiceStation.WebApp\Views\Reports\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1f12c320a54cd661005394b5fc7335bb625b726f"
// <auto-generated/>
...
#nullable disable
#nullable restore
#line 1 "C:\Users\vasil\Desktop\ServiceStation.API\ServiceStation.API\ServiceStation.WebApp\Views\Reports\Index.cshtml"
using System.Text.Json;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1f12c320a54cd661005394b5fc7335bb625b726f", @"/Views/Reports/Index.cshtml")]
    ...
    #nullable restore
    public class Views_Reports_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<DateRangeModel>
    #nullable disable
    {
        ...
        {
#nullable restore
#line 2 "C:\Users\vasil\Desktop\ServiceStation.API\ServiceStation.API\ServiceStation.WebApp\Views\Reports\Index.cshtml"
...
#nullable disable
            WriteLiteral("<h1>");
#nullable restore
#line 6 "C:\Users\vasil\Desktop\ServiceStation.API\ServiceStation.API\ServiceStation.WebApp\Views\Reports\Index.cshtml"
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "1f12c320a54cd661005394b5fc7335bb625b726f4944", async() => {
            }
            );
...
#nullable restore
#line 16 "C:\Users\vasil\Desktop\ServiceStation.API\ServiceStation.API\ServiceStation.WebApp\Views\Reports\Index.cshtml"
Write(Html.DropDownList("ServiceStation", new List<SelectListItem>(), new { @class = "form-control", @id = "dd-servicestation" }));
...
#nullable restore
#line 18 "C:\Users\vasil\Desktop\ServiceStation.API\ServiceStation.API\ServiceStation.WebApp\Views\Reports\Index.cshtml"
Write(Html.DropDownList("Client", new List<SelectListItem>(), new { @class = "form-control", @id = "dd-client" }));
...
#nullable restore
#line 20 "C:\Users\vasil\Desktop\ServiceStation.API\ServiceStation.API\ServiceStation.WebApp\Views\Reports\Index.cshtml"
Write(Html.DropDownList("Vehicle", new List<SelectListItem>(), new { @class = "form-control", @id = "dd-vehicle" }));
...
#nullable restore
#line 23 "C:\Users\vasil\Desktop\ServiceStation.API\ServiceStation.API\ServiceStation.WebApp\Views\Reports\Index.cshtml"
...
#nullable disable
            WriteLiteral("\r\n        ");
#nullable restore
#line 24 "C:\Users\vasil\Desktop\ServiceStation.API\ServiceStation.API\ServiceStation.WebApp\Views\Reports\Index.cshtml"
...
#nullable restore
#line 40 "C:\Users\vasil\Desktop\ServiceStation.API\ServiceStation.API\ServiceStation.WebApp\Views\Reports\Index.cshtml"
        ...
        $.ajax({
            ...
            success: function (user) {
                if (user == null || !user.isAuthenticated) {
                    window.location.href = """);
#nullable restore
#line 52 "C:\Users\vasil\Desktop\ServiceStation.API\ServiceStation.API\ServiceStation.WebApp\Views\Reports\Index.cshtml"
                                       Write(Url.Action("Index", "Login"));
...
#nullable disable
    ...
    function GetClients(serviceStationId) {
        ...
        $.ajax({
            ...
            success: function (response) {
                $.each(response, function (index, itemData) {
                    $(""#dd-client"").append($('<option></option>').text(itemDat");
            WriteLiteral(@"a.text).val(itemData.value));
                });
    ...
    function GenerateReport() {        
        ...
        if ($(""#dd-servicestation"").val() != ""0"")
            requets");
            WriteLiteral(@"Model.ServiceStationId = $(""#dd-servicestation"").val();
